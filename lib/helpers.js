...
export const isInt = value => Boolean(isset(value) && value.length && !isNaN(Number(value)))
export const isStr = value => Boolean(isset(value) && isInt(value) === false && isString(value))
...
export const isCheckableElement = field => isInputElement(field) && (isCheckboxElement(field) || isRadioElement(field))
export const isFileInputElement = field => isInputElement(field) && field.type === "file"
